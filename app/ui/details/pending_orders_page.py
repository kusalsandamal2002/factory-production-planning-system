...
class PendingOrdersPage(QWidget):
    ...
    def __init__(self, on_back=None):
        ...
        self.search_input.setPlaceholderText(
            "Search pending order no, customer, status, priority or note..."
        )
    ...
    def _build_ui(self) -> None:
        ...
        title = QLabel("Orders To Be Completed")
        title.setObjectName("SectionTitle")

        hint = QLabel(
            "Orders still waiting for production completion. Use this page to monitor remaining production workload."
        )
