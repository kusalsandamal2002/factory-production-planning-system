...
def _mpps_v22_daily_stock_latest_date(self):
    with engine.begin() as connection:
        return OperationalSourceService.latest(connection).plan_date
...
def _mpps_v22_daily_stock_source_for_date(self, stock_date):
    with engine.begin() as connection:
        ...
        live = OperationalSourceService.latest(connection)
        if live.plan_date == stock_date and live.import_run_id:
