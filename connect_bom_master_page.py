...
""",
    ...
    (
        '''            "bom_master": (
                ...
                "BOM Master",
                "Manage finished item to raw material usage and wastage percentages.",
            ),
''',
        '''            "bom_master": (
...
print("BOM Master page connected successfully.")
print("Factory Data Center -> BOM Master -> Open will now load the real BOM Master page.")